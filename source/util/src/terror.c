...
TAOS_DEFINE_ERROR(TSDB_CODE_MND_ARBITRATOR_ALREADY_EXIST, "Arbitrator already exists")
TAOS_DEFINE_ERROR(TSDB_CODE_MND_ARBITRATOR_NOT_EXIST,     "Arbitrator not there")
