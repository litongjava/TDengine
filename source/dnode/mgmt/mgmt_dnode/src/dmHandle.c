...
SArray *dmGetMsgHandles() {
  ...
  if (dmSetMgmtHandle(pArray, TDMT_DND_CREATE_ARBITRATOR, dmPutNodeMsgToMgmtQueue, 0) == NULL) goto _OVER;
  if (dmSetMgmtHandle(pArray, TDMT_DND_DROP_ARBITRATOR, dmPutNodeMsgToMgmtQueue, 0) == NULL) goto _OVER;
