...
#define TSDB_CODE_MND_ARBITRATOR_ALREADY_EXIST  TAOS_DEF_ERROR_CODE(0, 0x03AA)
#define TSDB_CODE_MND_ARBITRATOR_NOT_EXIST      TAOS_DEF_ERROR_CODE(0, 0x03AB)
...
#define TSDB_CODE_ARBITRATOR_ALREADY_DEPLOYED   TAOS_DEF_ERROR_CODE(0, 0x0417)
#define TSDB_CODE_ARBITRATOR_NOT_FOUND          TAOS_DEF_ERROR_CODE(0, 0x0418)
#define TSDB_CODE_ARBITRATOR_NOT_DEPLOYED       TAOS_DEF_ERROR_CODE(0, 0x0419)
...
// arbitrator
#define TSDB_CODE_ARB_NO_ENOUGH_NODE             TAOS_DEF_ERROR_CODE(0, 0x4200)
#define TSDB_CODE_ARB_INVALID_ARB_ID             TAOS_DEF_ERROR_CODE(0, 0x4201)
#define TSDB_CODE_ARB_INIT_FAILED                TAOS_DEF_ERROR_CODE(0, 0x4202)
#define TSDB_CODE_ARB_NOT_EXIST                  TAOS_DEF_ERROR_CODE(0, 0x4203)
#define TSDB_CODE_ARB_TOKEN_MISMATCH             TAOS_DEF_ERROR_CODE(0, 0x4204)
